...
class Recommender(object):
    ...
    def evaluateRecommendations(self, URM_test, at=5, minRatingsPerUser=1, exclude_seen=True,
        ...
        from SLIMBPR2.Base.Evaluation.Evaluator import SequentialEvaluator
    ...
    def m_recommend(self, target_ids, nRec=10):
        ...
        for tid in target_ids:
            results.append(self.recommend(tid, cutoff =nRec))
        return results

    def s_recommend(self, target_id, nRec=10):
        return self.recommend(target_id, cutoff=nRec)
    ...
    def saveModel(self, folder_path, file_name = None):
        ...
        np.savez(folder_path + "{}.npz".format(namePrefix), W=self.U, H=self.V)
