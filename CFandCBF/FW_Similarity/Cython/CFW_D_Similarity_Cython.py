...
from CFandCBF.KNN.ItemKNNCustomSimilarityRecommender import ItemKNNCustomSimilarityRecommender

from SLIM_BPR2.Base.SimilarityMatrixRecommender import SimilarityMatrixRecommender
from CFandCBF.Base.Incremental_Training_Early_Stopping import Incremental_Training_Early_Stopping
from CFandCBF.Base.Recommender import Recommender
from CFandCBF.Base.Recommender_utils import check_matrix
from CFandCBF.Base.IR_feature_weighting import okapi_BM_25, TF_IDF


from SLIM_BPR2.Base.Similarity.Compute_Similarity import Compute_Similarity
...
class CFW_D_Similarity_Cython(Incremental_Training_Early_Stopping, SimilarityMatrixRecommender, Recommender):
    ...
    def fit(self, validation_every_n = 5, show_max_performance = False, logFile = None, precompute_common_features = True,
        ...
        from CFandCBF.FW_Similarity.Cython.CFW_D_Similarity_Cython_SGD import CFW_D_Similarity_Cython_SGD
