...
from CFandCBF.Base.Similarity.Compute_Similarity_Python import Compute_Similarity_Python
from CFandCBF.Base.Similarity.Compute_Similarity_Euclidean import Compute_Similarity_Euclidean
