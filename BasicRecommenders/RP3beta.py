...
from SLIM_BPR2.Base.Recommender_utils import check_matrix, similarityMatrixTopK
...
class RP3betaRecommender(SimilarityMatrixRecommender, Recommender):
    ...
    def fit(self, alpha=1., beta=0.6, min_rating=0, topK=100, implicit=False, normalize_similarity=True, norm='l1'):
        ...
        if self.normalize_similarity:
            self.W = normalize(self.W, norm=self.norm, axis=1)
